...
/>
    ...
    חיטרובו מעמיק עוד ברעיון הקמת ארגון שיפעל למען הכנסייה והצליינים הרוסים בארץ ישראל, הוא מעלה את רעיונותיו על כתב ומעביר אותן לאנטונין קפוסטין. בבד ובד הוא גם יוצר קשר עם ראש המשלחת הדתית הרוסית לארץ ישראל לשעבר הארכימנדריט ליאוניד קאולין, ראש המנזר "ירושלים החדשה" במוסקבה. 
    
    רעיונותיו של חיטרובו לא נושאים חן בתחילה בעיני הגורמים בכנסייה וגם לא מתחבבים על ידידו קפוסטין, שבתחילה דוחה את הרעיון. רק כשנתיים לאחר ההצעה הראשונית קפוסטין מחליט לשים את כל כובד משקלו מאחורי הרעיון. קפוסטין יוצר קשר עם הרוזן א"ו פוטיאטין ומציג בפניו את חיטרובו ואת הרעיון החדש להקמת ארגון לא ממשלתי עבור פלשתינה. הרוזן מתאהב ברעיון, מציג אותו לחברה הגבוהה בסנט פטרסבורג ומעודד את יישומו. 
    חיטרובו מציע תקנון לאגודה ומעביר אותו לאישור המפקח על הסינוד הקדוש קונסטנטין פובדונוסצב. בבד ובד הרוזן פוטיאטין מקבל עותק של התקנון ומתחיל להחתים את האנשים הנכונים ובראשם הדוכס הגדול סרגיי אלכסנדרוביץ' שניאות לקבל עצמו להיות יושב הראש הראשון של האגודה. החתימה הראשית המתנוססת על תקנון האגודה היא של הצאר אלכסנדר השלישי.
