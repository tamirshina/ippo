...
בשנת 1911 טופלו בבית החולים בירושלים 22,000 מטופלים. בכלל המרפאות של האגודה בפלשטינה והמזרח התיכון (ארץ ישראל, סוריה ולבנון) נרשמו במהלך השנה ההיא מעל ל-100,000 מקרים שטופלו.
  ...
  headsOf: [
    ...
    },
    {
      name: "world.the22",
      id: "nine",
      info: `1970-1971 אלכסנדר גובר (1902-1971) - היסטוריון, מומחה לתרבות עמי דרום מזרח אסיה, דוקטור להיסטוריה, פרופסור באקדמיה הרוסית למדעים, אקדמאי של המכון הרוסי ללימודי המזרח. `,
      image: "09-headOf",
    },
    {
      name: "world.the22",
